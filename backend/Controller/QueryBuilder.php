        ...
        public static function getTotalComparisonCount($filters, $section){
            ...
            if ($filters['role'] == 'Verifier') {
                $query .= " AND (item_remarks = 'Comparison Created' 
                                OR item_remarks LIKE '%Comparison Approved by:%' OR item_remarks LIKE '%Comparison Verified by:%')";
            }
            ...
            if ($filters["role"] == "Requestor") {
                $query .= " AND (item_remarks = 'Comparison Acknowledge by: Wilfredo Arante' OR item_remarks LIKE '%Comparison Approved by:%')";
            }
