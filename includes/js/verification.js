$(document).ready(function () {
    ...
    $('#comparisonForm').on('submit', function(e) {
        ...
        const formData = $(this).serialize() + `&action=create_comparison&control_number=${controlNumber}&section=${requestorsection}&bccsection=${section}`;
        console.log('Receiver: ',requestorsection, 'Sender: ',section);
        Swal.fire({
            title: 'Are you sure?',
