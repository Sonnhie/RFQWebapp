        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div class="d-grid gap-2">
                    <button class="btn btn-custom btn-primary" id="newRfqBtn" data-bs-toggle="modal" data-bs-target="#newRfqModal">
...
<div class="row mb-4">
    <div class="col-md-3 mb-3">
        <div class="card dashboard-card" id="viewall" data-page="history">
            <div class="card-body">
