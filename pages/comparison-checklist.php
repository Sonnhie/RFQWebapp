...
<div class="col-12">
    ...
    <div class="row">
        <table class="table rfq-table table-hover ">
            ...
            <tbody id="comparisonTable" data-section="<?php echo $_SESSION['user']['department']; ?>" data-username="<?php echo $_SESSION['user']['username']; ?>" data-access="<?php echo $_SESSION['user']['access_level']; ?>">
