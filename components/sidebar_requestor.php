...
<nav class="sidebar justify-content-between" id="sidebar">
        ...
        <div class="sidebar-menu p-2">
            <ul class="nav nav-pills flex-column justify-content-between h-100">
                <div class="mt-3">
                    <li class="nav-item">
                    ...
                    <!-- <div class="mb-3 mt-3 ">
                        <h6 class="text-white text-uppercase">Quotation Management</h6>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="#" data-page="comparison-sheet">
